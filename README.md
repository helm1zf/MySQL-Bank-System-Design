# 🏦 Fadhali Bank: Implementation of Relational Database Design on Bank Schema
...
## 📖 Project Overview
This project is complete SQL implementation of a retail banking system called **Fadhali Bank**. It covers everything from customer management and branch organization to complex financial transactions and loan tracking.
...
I wrote a set of complex SQL queries to simulate the kind of reports a real bank manager would need. You can find these in the *queries_fadhali_bank_schema.sql* file.
...
## 🔍 How to Use it
1. **Build a Bank**: Run the *fadhali_bank_schema.sql* script in MySQL. It drops any old versions, creates the tables and seeds the data.
2. **Run Analytics**: Execute the queries in *queries_fadhali_bank_schema.sql* :SQL to see the business reports in actions.
